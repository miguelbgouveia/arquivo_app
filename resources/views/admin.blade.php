        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a class="btn btn-default" href="{{route('user_table')}}";>User <i class="fa fa-users" aria-hidden="true"></i></a>
                    <a class="btn btn-default" href="{{route('dashboard')}}">Admin <i class="fa fa-user" aria-hidden="true"></i></a>
                    <a class="btn btn-default" href="{{route('type.doc.table')}}">Ficheiros <i class="fa fa-file" aria-hidden="true"></i></a>
